...
export default function SkillsNebula() {
  ...
  return (
    <section className="min-h-screen py-20 bg-gradient-to-b from-gray-900/50 to-black" id="habilidades">
      <div className="container mx-auto px-4">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <h3 className="text-2xl font-bold text-center text-white mb-6">RESUMEN DE HABILIDADES</h3>
