...
export default function SpacePort() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'success',
        message: '✅ Mensaje enviado exitosamente! Recibirá respuesta en 24 horas.'
      });
  ...
  return (
    <section className="min-h-screen py-20 bg-gradient-to-b from-gray-900/50 to-black" id="contacto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a 
                  href="tel:+5493815476502" 
                  className="flex items-center justify-center p-4 bg-green-900/30 hover:bg-green-800/50 rounded-lg transition-colors group"
                >
                  <Phone className="text-green-400 group-hover:text-white mr-2" size={24} />
                  <span className="text-green-300 group-hover:text-white">Llamar</span>
                </a>
              </div>
            </div>
