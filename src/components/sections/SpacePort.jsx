...
export default function SpacePort() {
  ...
  return (
    <section id="contacto" className="min-h-screen py-20 bg-gradient-to-b from-gray-900/50 to-black">
          ...
          <div className="space-y-8">
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Gustavo Galdeano</h3>
                  <p className="text-cyan-300">CTO & Fundador @ Dragon Pyramid</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">gustavo_galdeano@yahoo.com.ar</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">Argentina (Remote Friendly)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20">
              <h3 className="text-2xl font-bold text-white mb-6">{t.socialConnections}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-gray-300 group-hover:text-white">{t.github}</span>
                </a>
                ...
                >
                  ...
                  <span className="text-blue-300 group-hover:text-white">{t.linkedin}</span>
                </a>
                ...
                >
                  ...
                  <span className="text-red-300 group-hover:text-white">{t.email}</span>
                </a>
                ...
                >
                  ...
                  <span className="text-green-300 group-hover:text-white">{t.web}</span>
                </a>
              </div>
            </div>
